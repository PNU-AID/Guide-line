...
**기초 수학**
- [혁펜하임의 "AI를 위한" 수학](https://youtube.com/playlist?list=PL_iJu012NOxea6yN2PUzw8hQ2Aniog8ql)

**선형대수학**
- [KOOC : AI 비전공자를 위한 기초 수학1: 선형대수학](https://kooc.kaist.ac.kr/mathforai/joinLectures/74606)
- [3Blue1Brown : Essence of linear algebra](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab)
- [혁펜하임의 "보이는" 선형대수학](https://youtube.com/playlist?list=PL_iJu012NOxdZDxoGsYidMf2_bERIQaP0)

**확률 통계**
- [Seeing Theory : Basic Probability/Compound Probability/Probability Distributions/Frequentist Inference/Basyesian Inference/Regression Analysis](https://seeing-theory.brown.edu/index.html#firstPage)
- [Statistics Fundamentals](https://youtube.com/playlist?list=PLblh5JKOoLUK0FLuzwntyYI10UQFUhsY9)
