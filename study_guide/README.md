...
예시
> **스터디 내용 : 고급 파이썬 스터디**<br/>
> **모집 인원 : 4명**<br/>
> **대면/비대면 여부 : 비대면(월 1회 대면)**<br/>
...
- **추석 전까지 스터디 혹은 프로젝트 필수로 참여 할 것!**
- 스터디에서 공부한 내용 블로그, 깃허브, 노션 등으로 기록하고 공유하고, 스터디가 만들어지면 운영진에게 공유부탁드립니다

## 스터디 현황
_취소선 그어진 스터디는 완료된 스터디 입니다_
|스터디 명|링크|
|:---:|:---:|
|aid_web|[Frontend](https://github.com/PNU-AID/AID_WEB_frontend), [Backend](https://github.com/PNU-AID/AID_WEB_backend)|
|pytorch 입문-1팀|[Notion Link](https://accurate-ray-c71.notion.site/Pytorch-9d96cbf05ab34850a50969d88d6b2583?pvs=4)|
|pytorch 입문-2팀||
...
|밑바닥부터시작하는 딥러닝|[Github Link](https://github.com/PNU-AID/DL-from-scratch-2)|
